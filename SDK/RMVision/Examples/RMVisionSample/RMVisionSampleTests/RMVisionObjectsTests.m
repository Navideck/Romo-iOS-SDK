...
@interface RMVisionObjectsTests : XCTestCase
...
- (void)testRMVisionTrainingDataWithNSCoder
{
    ...
    XCTAssertTrue(writeSuccessful, @"Failed to write encoded data to file: %@", path);
    ...
    XCTAssertTrue(areObjectsEqual, @"Modules are not equal after NSCoding");
