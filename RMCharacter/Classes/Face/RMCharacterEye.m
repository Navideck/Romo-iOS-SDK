...
{
    _emotion = emotion;
    self.image = [UIImage cacheableImageNamed:[NSString stringWithFormat:@"Romo_Emotion_%@eye_%d.png",_left ? @"L" : @"R", emotion]];
...
- (void)setClose:(float)close
{
    if (close != _close) {
        ...
        if (close < 0.95) {
            if (_close >= 0.95) {
                self.image = [UIImage cacheableImageNamed:[NSString stringWithFormat:@"Romo_Emotion_%@eye_%d.png",_left ? @"L" : @"R", _emotion]];
                self.clipsToBounds = YES;
            }
            ...
            self.image = [UIImage cacheableImageNamed:[NSString stringWithFormat:@"Romo_Emotion_%@eye_Closed.png",_left ? @"L" : @"R"]];
