...
The latest SDK works from **iOS 9.0** up to **iOS 14**! Older versions of the SDK also work with iOS 6, 7 and 8. Use CocoaPods to automatically get the latest version compatible with your iOS target.
